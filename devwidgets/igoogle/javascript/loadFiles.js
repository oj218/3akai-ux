...
/*global include_js loaded*/
    ...
    var makeArray = function(){
        ...
        urlArray.push(['/dev/_lib/jquery/jquery.js','js']);
        urlArray.push(['/dev/_lib/jquery/jquery-ui.full.js','js']);
        urlArray.push(['/dev/_lib/jquery/plugins/jquery.json.js','js']);
        urlArray.push(['/dev/_lib/sakai_util/trimpath.template.js','js']);
        urlArray.push(['/dev/_lib/Fluid/3akai_Infusion.js','js']);
        urlArray.push(['/dev/_lib/sakai_util/sdata.js','js']);
        urlArray.push(['/dev/_lib/jquery/plugins/jquery.threedots.js','js']);
        urlArray.push(['/dev/_configuration/config.js','js'],'js');
        urlArray.push(['/dev/_lib/sakai_util/sakai_magic.js','js']);
        urlArray.push(['/devwidgets/igoogle/javascript/igoogle.js','js']);
        urlArray.push(['/dev/_css/sakai/sakai.base.css','css']);
        urlArray.push(['/devwidgets/igoogle/css/igoogle.css','css']);
    };
